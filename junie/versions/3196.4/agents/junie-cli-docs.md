...
* **A model with Computer Use support.** Right now only **GPT‑5.4, GPT‑5.5,
  and GPT‑5.6 SOL** are supported. More models will be added later as
...
GPT‑5.4, GPT‑5.5, and GPT‑5.6 SOL; more models will land later. Switch via
[Junie CLI Model selection](Junie-CLI-Model-selection.md).
