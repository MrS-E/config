...
| `/brave`                 | Toggle [brave mode](Junie-CLI.md#brave-mode), in which Junie CLI executes all potentially sensitive actions without user approval.                                                                                                                                                                                                                               |
...
| `Ctrl+B`    | Enable [brave mode](Junie-CLI.md#brave-mode).                                           |
